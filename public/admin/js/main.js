...
//'DOMContentLoaded' el evento es disparado cuando el documento
//HTML ha sido completamente cargado y parseado sin esperar imagenes,estilos etc
...
async function addPosts () {
    ...
    posts.forEach((post) => {
        ...
        `
        //insertAdjacentHTML() inserta la cadena HTML en el DOM
        //'beforeend' inserta dentro del elemento despues de su ultimo hijo
